...
public class Main {
    public static void main(String[] args) {
        ...
        primeiraPessoa.setNome("Joao");
        primeiraPessoa.setSobrenome("Silva");
        primeiraPessoa.setIdade(18);
        primeiraPessoa.setNumero("985469988");


        Pessoa segundaPessoa = new Pessoa();

        segundaPessoa.setNome("Joana");
        segundaPessoa.setSobrenome("Maria");
        segundaPessoa.setIdade(15);
        segundaPessoa.setNumero("988769988");
